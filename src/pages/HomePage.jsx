...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      {/* login section */}
      <section className="py-12 px-4 bg-gray-200/80">
        <div className="max-w-screen-xl mx-auto">
          <div className="flex flex-col items-center md:flex-row md:items-center justify-center space-y-4 md:space-y-0 md:space-x-6">
            ...
            {/* Login Button */}
            <button className="text-white/90 bg-red-700/90 hover:bg-red-700 text-xl font-semibold uppercase px-5 rounded-sm py-1">
              {t("login.loginbtn")}
            </button>
